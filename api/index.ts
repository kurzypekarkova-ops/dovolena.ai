...
💡 **Lokální tip**: [MIMOŘÁDNĚ SPECIFICKÁ, autentická a originální rada, skryté místo, netradiční zážitek nebo tip na konkrétní tajný podnik / vyhlídku, která se týká EXKLUZIVNĚ vyhledávané lokality (např. "${destination}"). Nikdy nedávej obecné rady (typu "pijte vodu", "mějte u sebe hotovost" nebo "předem si rezervujte lístky"). Tip musí být tak konkrétní a jedinečný pro ${destination}, aby ho znali a ocenili jen opravdoví domorodci oder zkušení místní průvodci a dával dokonalý smysl v kombinaci se zvoleným stylem cesty a společníkem!]
...
- [položka 1 s humorným/přísným vysvětlením, Tracking pochybení, proč ji nechat doma]
- [položka 2]
...
- Dostatek svačinek a vlhčené ubrousky (zachrání každou situation).` : ""}
